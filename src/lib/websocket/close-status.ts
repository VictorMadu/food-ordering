export class CloseStatus {
   ...
   */
  public static readonly NORMAL: CloseStatus = new CloseStatus(1000);

  /**
   * "1001 indicates that an endpoint is "going away", such as a server going down or a
   * browser having navigated away from a page."
   */
  public static readonly GOING_AWAY: CloseStatus = new CloseStatus(1001);

  /**
   * "1002 indicates that an endpoint is terminating the connection due to a protocol
   * error."
   */
  public static readonly PROTOCOL_ERROR: CloseStatus = new CloseStatus(1002);
   ...
   */
  public static readonly NOT_ACCEPTABLE: CloseStatus = new CloseStatus(1003);
   ...
   */
  public static readonly NO_STATUS_CODE: CloseStatus = new CloseStatus(1005);
   ...
   */
  public static readonly NO_CLOSE_FRAME: CloseStatus = new CloseStatus(1006);
   ...
   */
  public static readonly BAD_DATA: CloseStatus = new CloseStatus(1007);
   ...
   */
  public static readonly POLICY_VIOLATION: CloseStatus = new CloseStatus(1008);

  /**
   * "1009 indicates that an endpoint is terminating the connection because it has
   * received a message that is too big for it to process."
   */
  public static readonly TOO_BIG_TO_PROCESS: CloseStatus = new CloseStatus(1009);
   ...
   */
  public static readonly REQUIRED_EXTENSION: CloseStatus = new CloseStatus(1010);

  /**
   * "1011 indicates that a server is terminating the connection because it encountered
   * an unexpected condition that prevented it from fulfilling the request."
   */
  public static readonly SERVER_ERROR: CloseStatus = new CloseStatus(1011);
   ...
   */
  public static readonly SERVICE_RESTARTED: CloseStatus = new CloseStatus(1012);
   ...
   */
  public static readonly SERVICE_OVERLOAD: CloseStatus = new CloseStatus(1013);
   ...
   */
  public static readonly TLS_HANDSHAKE_FAILURE: CloseStatus = new CloseStatus(1015);
   ...
   * @since 4.0.3
   */
  public static readonly SESSION_NOT_RELIABLE: CloseStatus = new CloseStatus(4500).withReason(
    'Failed to send message within the configured send limit',
  );
   ...
   */
  constructor(code: number, reason: string | null = null) {
    this.code = code;
    this.reason = reason;
    this.validateCode();
  }
   ...
   */
  public withReason(reason: string): CloseStatus {
    return new CloseStatus(this.code, reason);
  }

  public equalsCode(other: CloseStatus): boolean {
  ...
  public equals(other: any): boolean {
    return (
      this === other ||
      (other instanceof CloseStatus &&
        this.code === other.code &&
        Object.is(this.reason, other.reason))
    );
  }

  private validateCode(): void {
    if (!(this.code >= 1000 && this.code < 5000)) {
      throw new Error(`Invalid status code: ${this.code}`);
    }
  }
}
